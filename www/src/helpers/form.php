...
function createInputForField(Field $field, string $id)
{
    ...
    return "<input type=\"$field->type\" name=\"$id\" id=\"$id\" value=\"$field->value\"class=\"focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md\">";
}
